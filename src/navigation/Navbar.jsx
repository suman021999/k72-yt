...
import { NavbarColorContext, NavbarContext } from '../hooks/NavContext'
...
const Navbar = () => {
  ...
  return (
    <>
      <section className='z-4 flex fixed  top-0 w-full items-start justify-between'>
        <div className='lg:p-5 p-2 '>
          <Link to='/' >
                    <svg className='lg:w-36 w-24' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103 44">
          ...
          onMouseLeave={()=>{
           ...
           className='lg:h-16 h-10 relative bg-black lg:w-[16vw] w-48'>
